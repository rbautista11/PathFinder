...
if("FALSE" STREQUAL "TRUE")
  set(lab7_SOURCE_PREFIX /home/rafael/CSE180/src/lab7)
  set(lab7_DEVEL_PREFIX /home/rafael/CSE180/devel)
  set(lab7_INSTALL_PREFIX "")
  set(lab7_PREFIX ${lab7_DEVEL_PREFIX})
else()
  set(lab7_SOURCE_PREFIX "")
  set(lab7_DEVEL_PREFIX "")
  set(lab7_INSTALL_PREFIX /home/rafael/CSE180/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'rafael <rafael@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rafael/CSE180/install/${idir}'.  Ask the maintainer 'rafael <rafael@todo.todo>' to fix it.")
    endif()
